...
the reservation fee will be deduced from the final bill  </p>
		 ...
		 <form method=POST >
			...
			<div class="form-group  col-md-6 text-right ">
				...
				<br>
		<select type=hidden name=no_of_adults class="totalNum">
		...
		<div class="form-group  col-md-6">
				...
				<br>
		<select type=hidden name=no_of_kids  class="totalNum" >
		<option selected>0</option>
		<option>1</option>
		<option>2 </option>
		<option>3 </option>
		...
		<div class="form-group  col-md-6 text-right">
				<label>Time</label>
				<br>
				<select type=hidden name=hidden_time class="NumberOfAdults" >
		...
		<div class="form-group  col-md-6 ">
				<label>Date</label>
				<br>
				<select type=hidden name=hidden_date class="NumberOfAdults" >
 ...
 <div class="form-group">
    <textarea type=hidden name =hidden_comment class="form-control text-center" rows="7" >Enter your comment here...!!!!</textarea>
  </div>

 <div class="text-center">
        <div class="text ">
          <p><span>Total:<input id="sum" type=text  type=hidden name =hidden_food_price  disabled='true' size="5"/></span></p>
        </div>
      </div>

<button type="submit" name="add_ticket" class="btn btn-default" align="middle">Add to cart</button>
